...
| Date | Change |
| ------ | ---- |
| Apr 1, 2020. 9:00am ET | **Stop returning Face object from API**<br><br> This is part of deprecation of Face object from API. Currently as transition period, we are returning both `data.face` and `data.concept`. We will stop returning `data.face` after Apr 1st 2020. For more details on how to use `data.concept`, please check [here](https://docs.clarifai.com/product-updates/upcoming-api-changes#deprecation-face-from-api) |
...
```
<br>Similar examples could be made for all other languages. If you need help in the conversion, feel free to reach out to support@clarifai.com. </br>
