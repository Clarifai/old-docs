...
![Image showing the top-level Applications page on the Clarifai Developer website](https://github.com/Clarifai/docs/tree/812eab0a1a002aa7427f55c7e467a7a3315846ef/.gitbook/assets/application-screen-new.png)

Then under that application, you will see a section labeled "App Workflows" and a button to "Create Workflow".

![Image showing My First Application and the Create Workflow button underneath the Create API Key](https://github.com/Clarifai/docs/tree/812eab0a1a002aa7427f55c7e467a7a3315846ef/.gitbook/assets/create-workflow-new.png)
...
![Image showing a list of models \(Moderation and General\) under a workflow with the name my-workflow](https://github.com/Clarifai/docs/tree/812eab0a1a002aa7427f55c7e467a7a3315846ef/.gitbook/assets/my-workflow-new.png)
...
![Image showing the Portal&apos;s workflow prediction results](https://github.com/Clarifai/docs/tree/812eab0a1a002aa7427f55c7e467a7a3315846ef/.gitbook/assets/preview-workflows-new.png)
