...
After you have [added inputs](../data-management/inputs.md#add-inputs-with-concepts), [annotation the inputs](../data-management/annotations.md#add-annotations), and try a custom model, you can search by those concepts.
