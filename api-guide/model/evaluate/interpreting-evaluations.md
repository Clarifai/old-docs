...
![](../../../.gitbook/assets/eval-results-new%20%282%29.png) Once the Model Evaluation is complete, you’ll be able to view the evaluation results in the [Portal here](https://clarifai.com/apps)
...
![model eval summary](../../../.gitbook/assets/eval-summary-table%20%282%29%20%281%29.png) This table summarizes the numerical evaluation results for every concept. For every concept, it calculates:
...
![not expanded](../../../.gitbook/assets/not-expanded-new%20%282%29.png) This Selection Details table shows the input-level details of the selection you made on the Summary Table or Concept by Concept Results. It shows the image input and prediction probabilities for a specific concept.
